      ...
      <div className="mx-auto max-w-7xl">
        <section className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-black leading-tight tracking-tight text-white mb-4">
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 h-auto md:h-[900px]">
          ...
          {/* Video Tile */}
          <div className="md:col-span-2 md:row-span-1 relative overflow-hidden rounded-xl bg-primary/5 border border-primary/20 aspect-video md:aspect-auto">
          ...
          {/* Small Items */}
          <div className="relative group overflow-hidden rounded-xl bg-slate-800 aspect-[4/3] md:aspect-auto">
          ...
          {/* Vertical Tall Item */}
          <div className="md:col-span-1 md:row-span-1 relative group overflow-hidden rounded-xl bg-slate-800 aspect-[3/4] md:aspect-auto">
          ...
          <div className="md:col-span-2 md:row-span-1 relative group overflow-hidden rounded-xl bg-slate-800 aspect-video md:aspect-auto">
