    ...
    <section className="py-24 px-6 md:px-12 bg-[#1a1a1a]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="w-full md:w-1/2">
          ...
          <h2 className="text-white text-3xl md:text-4xl font-black mb-6 leading-tight">CRAFTED FOR THE <br />DISCERNING PALATE</h2>
          ...
          <button className="border-2 border-primary text-primary px-6 py-3 md:px-8 rounded-full font-bold hover:bg-primary hover:text-[#121212] transition-all">
            EXPLORE FULL MENU
          </button>
        </div>
      </div>
