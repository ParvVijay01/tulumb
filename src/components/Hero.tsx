    ...
    <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mt-20">
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="group relative flex items-center justify-center bg-primary text-[#121212] px-10 py-5 rounded-full text-lg font-bold tracking-[0.1em] hover:bg-white transition-all shadow-[0_0_30px_rgba(236,164,19,0.3)]"
        >
          BOOK YOUR EVENING
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8">
          {[
            ...
            <motion.div 
              ...
              className="flex items-center gap-3 bg-white/5 backdrop-blur-md border border-white/10 px-6 py-3 rounded-full"
            >
              <stat.icon className="w-4 h-4 text-primary" />
              <span className="text-white text-sm font-medium tracking-wide">{stat.text}</span>
            </motion.div>
          ))}
        </div>
      </div>
