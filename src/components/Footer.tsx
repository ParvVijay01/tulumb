  ...
  return (
    <footer className="bg-[#121212] pt-24 pb-12 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Delivery Section */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-[#1a2e25]/20 p-12 rounded-3xl border border-primary/5 mb-24">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a href="#" className="flex items-center gap-4 bg-[#E23744] hover:bg-[#E23744]/90 text-white px-8 py-4 rounded-2xl font-bold transition-transform hover:-translate-y-1">
              <img src={IMAGES.zomatoLogo} alt="Zomato" className="h-6 brightness-0 invert" referrerPolicy="no-referrer" />
              Order on Zomato
            </a>
            <a href="#" className="flex items-center gap-4 bg-[#FC8019] hover:bg-[#FC8019]/90 text-white px-8 py-4 rounded-2xl font-bold transition-transform hover:-translate-y-1">
      ...
      <div className="fixed bottom-8 right-8 z-[100]">
        <motion.button 
          whileHover={{ pr: 32 }}
          className="group relative flex items-center gap-3 rounded-full bg-primary px-6 py-4 text-[#121212] shadow-2xl transition-all active:scale-95"
        >
          ...
          <span className="font-bold tracking-tight">Planning a Party? Contact Us</span>
